...
// Start VS with admin rights ( Run as administrator )
...
namespace LessonEleven
{
    ...
    class Program
    {
        ...
        static void LessonEleven(string[] args)
        {
            ...
            DirectoryInfo dereksDir = new DirectoryInfo(@"C:\path\to\file");
            ...
            // Create a directory
            DirectoryInfo dataDir = new DirectoryInfo(@"C:\path\to\file");
            dataDir.Create();
            ...
            string textFilePath = @"C:\path\to\file\filename.txt";
            ;
            // Write the array
            ...
            DirectoryInfo myDataDir = new DirectoryInfo(@"C:\path\to\file");
            ...
            string textFilePath2 = @"C:\path\to\file\filename2.txt";
            ...
            string textFilePath3 = @"C:\path\to\file\filename3.txt";
            ...
            string textFilePath4 = @"C:\path\to\file\filename4.dat";
